                    ...
                    <div className="w-full h-full flex items-center justify-center">
                        <div className="bg-[#e6f5f0] w-full h-full p-4 md:p-8 overflow-y-auto">
                            <div className="flex justify-between items-center mb-4 bg-[#7fd1df] p-2 rounded-xl">
                                <h2 className="text-xl md:text-3xl text-center hover:underline flex-grow">AI Agents: Smarter Solutions for a Smarter Future</h2>
                                <button
                                    type="button"
                            ...
                            Our AI agents empower businesses with automation, predictive insights, and personalized experiences. 
                            From chatbots to advanced machine learning models, we tailor AI to fit your unique goals.                            </p>
                            ...
                            <ul className="list-disc list-inside text-sm md:text-lg mb-4 text-justify">
                                <li className="mb-2">Intelligent chatbots and virtual assistants</li>
                                <li className="mb-2">Predictive analytics and data modeling</li>
                                <li className="mb-2">Ongoing optimization and training</li>
                            </ul>
                            ...
                            <ul className="list-disc list-inside text-sm md:text-lg mb-4 text-justify">
                                <li className="mb-2">Save time with automated workflows</li>
                                <li className="mb-2">Gain actionable insights from data</li>
                                <li className="mb-2">Enhance customer satisfaction with 24/7 support</li>
                            </ul>

                            <p className="text-sm md:text-lg mb-4 text-justify">
                                Discover how AI can transform your business—get in touch now!
                            </p>

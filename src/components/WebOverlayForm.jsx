                    ...
                    <div className="w-full h-full flex items-center justify-center">
                        <div className="bg-[#e6f5f0] w-full h-full p-4 md:p-8 overflow-y-auto">
                            <div className="flex justify-between items-center mb-4 bg-[#7fd1df] p-2 rounded-xl">
                                <h2 className="text-xl md:text-3xl text-center hover:underline flex-grow">Web Development: Your Digital Presence, Perfected</h2>
                                <button
                                    type="button"
                            ...
                            We design and build responsive, high-performance websites that reflect your brand and drive conversions.
                            From e-commerce platforms to corporate sites, we deliver pixel-perfect solutions.                            </p>
                            ...
                            <ul className="list-disc list-inside text-sm md:text-lg mb-4 text-justify">
                                ...
                                <li className="mb-2">E-commerce and CMS integration (e.g., WordPress, Shopify)</li>
                                <li className="mb-2">SEO and performance optimization</li>
                                <li className="mb-2">Secure hosting and maintenance</li>
                            </ul>
                            ...
                            <ul className="list-disc list-inside text-sm md:text-lg mb-4 text-justify">
                                <li className="mb-2">Attract more visitors with stunning visuals</li>
                                <li className="mb-2">Convert leads with optimized functionality</li>
                                <li className="mb-2">Stay ahead with cutting-edge tech</li>
                            </ul>

                            <p className="text-sm md:text-lg mb-4 text-justify">
                                Launch your website today—contact us for a custom quote!
                            </p>

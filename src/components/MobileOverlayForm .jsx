                    ...
                    <div className="w-full h-full flex items-center justify-center">
                        <div className="bg-[#e6f5f0] w-full h-full p-4 md:p-8 overflow-y-auto">
                            <div className="flex justify-between items-center mb-4 bg-[#7fd1df] p-2 rounded-xl">
                                <h2 className="text-xl md:text-3xl text-center hover:underline flex-grow">Mobile App Development: Your Vision, Our Expertise</h2>
                                <button
                                    type="button"
                            ...
                            <p className="text-sm md:text-xl mb-4 text-justify mt-4">
                                "We bring your app ideas to life with custom mobile solutions for iOS, Android, and cross-platform environments. Whether it’s a startup MVP or an enterprise-grade application, our team delivers seamless performance and stunning design."
                            </p>
                            ...
                            <ul className="list-disc list-inside text-sm md:text-lg mb-4 text-justify">
                                <li className="mb-2">Custom iOS and Android app development</li>
                                <li className="mb-2">Cross-platform frameworks (e.g., Flutter, React Native)</li>
                                <li className="mb-2">UI/UX design and prototyping</li>
                                <li className="mb-2">App store deployment and support</li>
                            </ul>
                            ...
                            <ul className="list-disc list-inside text-sm md:text-lg mb-4 text-justify">
                                <li className="mb-2">Reach wider audiences with mobile-first solutions</li>
                                <li className="mb-2">Boost user engagement with intuitive designs</li>
                                <li className="mb-2">Scale effortlessly with robust architecture</li>
                            </ul>
...
export default MobileOverlayForm;
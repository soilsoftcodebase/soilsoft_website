                    ...
                    <div className="w-full h-full flex items-center justify-center">
                        <div className="bg-[#e6f5f0] w-full h-full p-4 md:p-8 overflow-y-auto">
                            <div className="flex justify-between items-center mb-4 bg-[#7fd1df] p-2 rounded-xl">
                                <h2 className="text-xl md:text-3xl text-center hover:underline flex-grow">QA and Automation: Quality You Can Trust</h2>
                                <button
                                    type="button"
                            ...
                            Our QA and automation services ensure your software performs flawlessly under any condition. 
                            We combine manual expertise with cutting-edge automation tools to deliver reliable, scalable results.                            </p>
                            ...
                            <ul className="list-disc list-inside text-sm md:text-lg mb-4 text-justify">
                                <li className="mb-2">Automated functional and regression testing</li>
                                <li className="mb-2">Performance and load testing</li>
                                <li className="mb-2">Bug detection and resolution</li>
                                <li className="mb-2">Continuous integration testing support</li>
                            </ul>
                            ...
                            <ul className="list-disc list-inside text-sm md:text-lg mb-4 text-justify">
                                <li className="mb-2">Reduce release cycles with faster testing</li>
                                <li className="mb-2">Minimize errors and downtime</li>
                                <li className="mb-2">Ensure a seamless user experience</li>
                            </ul>

                            <p className="text-sm md:text-lg mb-4 text-justify">
                                Let’s perfect your product—schedule a QA consultation today!
                            </p>
